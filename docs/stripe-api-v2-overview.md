...
| **Test your integration** | Validate APIs in the `/v1` namespace using Sandboxes, an isolated environment. | Validate APIs in the `/v2` namespace using Sandboxes, an isolated environment.
...
**Read more:** [Idempotency](https://docs.stripe.com/api-v2-overview.md#idempotency) |
...
**Read more:** [List pagination](https://docs.stripe.com/api-v2-overview.md#list-pagination) |
...
**Read more:** [Expanding responses](https://docs.stripe.com/expand.md) | The `expand` parameter isn't supported. Some APIs in this namespace might provide additional fields in their responses by using the [include parameter](https://docs.stripe.com/api-includable-response-values.md). |
...
To access APIs in the `/v2` namespace using the Stripe CLI, use the command `stripe v2`. For example, to list all [v2 Accounts](https://docs.stripe.com/api/v2/core/accounts.md), you can use `stripe v2 core accounts list`.
...
- Not all `/v2` APIs support [test mode sandboxes](https://docs.stripe.com/testing-use-cases.md#compare). You can always test `/v2` endpoints in a sandbox.
